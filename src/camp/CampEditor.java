...
/**
 * The {@code CampEditor} class provides methods to edit various attributes of a camp.
 *
 * Instances of this class are used to modify the editable properties of a given camp's {@code CampInfo},
 * such as its name, description, location, dates, and visibility.
 * The changes made through the editor can be retrieved using the {@code getEditedCamp} method.
 *
...
public class CampEditor {
     ...
     *
     * @param isVisible {@code true} to make the camp visible, {@code false} otherwise.
     */
